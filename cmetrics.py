...
def cmeasure(Label, labels):
    ...
    str = 'The obtained ACC: %f' %accuracy + '\n'
    print(str)
    ...
    homo = metrics.homogeneity_score(Label, labels)
    comp = metrics.completeness_score(Label, labels)
    str = 'The obtained homogeneity score: %f' %homo
    print(str)
    str = 'The obtained completeness score: %f' %comp
    print(str)    
    
    
    # +++++ Fowlkes-Mallows scores +++++
    fowl = metrics.fowlkes_mallows_score(Label, labels)
    str = 'The obtained Fowlkes-Mallows scores: %f' %fowl
    print(str)
    
    #return nmi, avg, acc, f, p, r, ar, ri, MI, HI
    
    return nmi, avg, f, p, r, ar, ri, MI, HI, homo, comp, fowl


# +++++++++++++ The Evaluation for the cases of unknown ground truth ++++++++++++
def ugtMeasure(X, labels):
    # +++++ Silhouette Coefficient +++++
    silh = metrics.silhouette_score(X, labels, metric='euclidean')
    str = 'The obtained Silhouette Coefficient: %f' %silh
    print(str)
    
    # +++++ Calinski-Harabasz Index +++++
    cali = metrics.calinski_harabasz_score(X, labels)   
    str = 'The obtained Calinski-Harabasz Index: %f' %cali
    print(str)
    
    # +++++ Davis-Bouldin Index +++++
    davi = metrics.davies_bouldin_score(X, labels)
    str = 'The obtained Davies-Bouldin Index: %f' %davi
    print(str)
    

    # +++++ Contingency Matrix +++++
    
    return silh, cali, davi
